...
class BroadcomXdslcmdShClientImpl extends CommonTelnetClient {
  BroadcomXdslcmdShClientImpl({required super.unitIp, required String login, required String password})
      : super(
          prepPrts: [
