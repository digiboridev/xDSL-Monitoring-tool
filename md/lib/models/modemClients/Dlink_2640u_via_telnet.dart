...
// import 'BCMTelnetParser.dart';

// class Dlink_2640u_via_telnet implements Client {
//   //variables
//   final String _ip;
//   final String user;
...
//   //constructor
//   Dlink_2640u_via_telnet({ip, extIp, user, password})
//       : _ip = ip,
//         _extIp = extIp,
//         user = user,
//         password = password;
...
//     var parser = BCMTelnetParser((collection) {
//       sub.cancel();
...
//       if ('Login:'.allMatches(answer).isNotEmpty) {
//         socket.write('$user\n');
//       } else if ('Password:'.allMatches(answer).isNotEmpty) {
//         socket.write('$password\n');
//       } else if ('You have a full access.'.allMatches(answer).isNotEmpty) {
//         socket.write('sh\n');
//       } else if ('~ #'.allMatches(answer).isNotEmpty) {
//         sub.cancel();
