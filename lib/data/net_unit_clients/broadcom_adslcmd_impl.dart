...
class BroadcomAdslcmdClientImpl extends CommonTelnetClient {
  BroadcomAdslcmdClientImpl({required super.unitIp, required String login, required String password})
      : super(
          prepPrts: [
