...
//   static AvgStatsData computeFunc(List<LineStats> collection) {
//     //calc time beetween first and last sample
//     Duration time() {
//       if (collection.length > 1) {
//         LineStats first = collection.first;
//         LineStats last = collection.last;
//         return last.time.difference(first.time);
//       } else {
...
//         collection[i].status == SampleStatus.samplingError ? count++ : {};
//       }
//       return count;
//     }
...
//         if (collection[i - 1].status == SampleStatus.connectionUp && collection[i].status == SampleStatus.connectionDown) {
//           count++;
//         }
//       }
//       return count;
