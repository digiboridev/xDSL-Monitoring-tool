...
class BroadcomXdslcmdClientImpl extends CommonTelnetClient {
  BroadcomXdslcmdClientImpl({required super.unitIp, required String login, required String password})
      : super(
          prepPrts: [
