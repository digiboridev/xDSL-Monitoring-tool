...
class ExternalLatency extends StatefulWidget {
  final List<LineStatsCollection> collection;
  final Duration? showPeriod;

  const ExternalLatency({super.key, required this.collection, this.showPeriod});

  @override
  State<ExternalLatency> createState() => _ExternalLatencyState();
}

class _ExternalLatencyState extends State<ExternalLatency> {
...
class ExternalLatencyExpandable extends StatefulWidget {
  final List<LineStatsCollection> collection;
  final Duration? showPeriod;
  final bool isEmpty;

  const ExternalLatencyExpandable({super.key, required this.isEmpty, required this.collection, this.showPeriod});

  @override
  State<ExternalLatencyExpandable> createState() => _ExternalLatencyExpandableState();
}

class _ExternalLatencyExpandableState extends State<ExternalLatencyExpandable> {
  bool _show = false;
  @override
  Widget build(BuildContext context) {
    return Column(
