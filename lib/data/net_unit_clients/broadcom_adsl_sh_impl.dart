...
class BroadcomAdslShClientImpl extends CommonTelnetClient {
  BroadcomAdslShClientImpl({required super.unitIp, required String login, required String password})
      : super(
          prepPrts: [
