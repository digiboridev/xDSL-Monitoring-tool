...
class ExternalLatency extends StatefulWidget {
  ...
  ExternalLatency({this.collection, this.showPeriod});

  @override
  _ExternalLatencyState createState() => _ExternalLatencyState();
}
...
class ExternalLatencyExpandable extends StatefulWidget {
  ...
  ExternalLatencyExpandable({this.isEmpty, this.collection, this.showPeriod});

  @override
  _ExternalLatencyExpandableState createState() =>
      _ExternalLatencyExpandableState();
}
