...
class SnapshotStatsTable extends Table {
  ...
  IntColumn get downRateSum => integer().nullable()();
  IntColumn get downRateCount => integer().nullable()();
  ...
  IntColumn get downAttainableRateSum => integer().nullable()();
  IntColumn get downAttainableRateCount => integer().nullable()();
  ...
  IntColumn get upRateSum => integer().nullable()();
  IntColumn get upRateCount => integer().nullable()();
  ...
  IntColumn get upAttainableRateSum => integer().nullable()();
  IntColumn get upAttainableRateCount => integer().nullable()();
  ...
  IntColumn get downSNRmSum => integer().nullable()();
  IntColumn get downSNRmCount => integer().nullable()();
  ...
  IntColumn get upSNRmSum => integer().nullable()();
  IntColumn get upSNRmCount => integer().nullable()();
  ...
  IntColumn get downAttenuationSum => integer().nullable()();
  IntColumn get downAttenuationCount => integer().nullable()();
  ...
  IntColumn get upAttenuationSum => integer().nullable()();
  IntColumn get upAttenuationCount => integer().nullable()();
